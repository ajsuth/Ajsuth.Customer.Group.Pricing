...
{
    public class CalculateVariationsSellPriceBlock : Sitecore.Commerce.Plugin.Catalog.CalculateVariationsSellPriceBlock
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculateVariationsSellPriceBlock"/> class.
        /// </summary>
        /// <param name="commander">The commerce commander.</param>
        public CalculateVariationsSellPriceBlock(CommerceCommander commander) : base(commander)
        {
        }
